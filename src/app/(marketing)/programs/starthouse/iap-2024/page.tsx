...
export default function IAP2024() {
  return (
    <div>
      <section id="iap-2024-hero" className="container mx-auto py-14">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-foreground/80 text-lg font-medium tracking-tight text-balance mb-8">
            The latest cohort of StartHouse participants and their innovative projects.
          </p>
        </div>
      </section>
