...
export function MobileNav({ className }: { className?: string }) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className="bg-background/90 h-[--radix-popper-available-height] w-[--radix-popper-available-width] overflow-y-auto rounded-none border-none p-0 shadow-none backdrop-blur duration-100"
        align="start"
        side="bottom"
        alignOffset={-16}
        sideOffset={14}
